...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper, Schedule> implements ScheduleService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        if (targetSchedule != null) {
            schedule.setUpdateTime(targetSchedule.getUpdateTime());
...
//        scheduleRepository.save(schedule);
    ...
    public Map<String, Object> getScheduleRule(Long page, Long limit, String hoscode, String depcode) {
        ...
        objectMap.put("hosname", hosName);
        result.put("baseMap", objectMap);
    ...
    public ScheduleOrderVo getScheduleOrderVo(String scheduleId) {
        ...
        if (null == schedule) throw new YyghException(ResultCodeEnum.PARAM_ERROR);
        //获取预约规则信息
        Hospital hospital = hospitalService.getByHoscode(schedule.getHoscode());
        if (null == hospital) throw new YyghException(ResultCodeEnum.DATA_ERROR);
        BookingRule bookingRule = hospital.getBookingRule();
        if (null == bookingRule) throw new YyghException(ResultCodeEnum.PARAM_ERROR);
        ...
        DateTime quitTime = this.getDateTime(
                new DateTime(schedule.getWorkDate()).plusDays(quitDay).toDate(), bookingRule.getQuitTime());
    ...
    private Schedule packageSchedule(Schedule schedule) {
        //设置医院名称
        schedule.getParam().put("hoaname", hospitalService.getHospName(schedule.getHoscode()));
        //设置科室名称
